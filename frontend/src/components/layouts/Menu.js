          ...
          <nav>
            <ul>
              ...
              </li>
              {
                <li>
                  <a
                    onClick={e => dispatch({ type: "USER_TASK_DEMAND" })}
                    id="task"
                  >
                    Tasks
                  </a>
              ...
              <li>
                <a
                  href="#"
                  onClick={e => dispatch({ type: "USER_ISSUE_DEMAND" })}
                >
                  Issues
                </a>
              </li>
              <li>
                <a
                  href="#"
                  onClick={e => dispatch({ type: "USER_MESSAGE_DEMAND" })}
                >
                  Messages
                </a>
              </li>
              ...
              {registerDemand && !connexionDemand && (
                <li>
                  <a
                    onClick={e => dispatch({ type: "USER_CONNEXION_DEMAND" })}
                    id="connect"
                  >
                    Login
                  </a>
              ...
              {!registerDemand && !connexionDemand && (
                <li>
                  <a
                    className="red"
                    onClick={e => dispatch({ type: "USER_LOGOUT" })}
                    id="disconnect"
                  >
                    {" "}
                    Logout
              ...
              {!registerDemand && connexionDemand && (
                <li>
                  <a
                    className="red"
                    onClick={e => dispatch({ type: "USER_REGISTER_DEMAND" })}
                    id="register"
                  >
                    Register
                  </a>
