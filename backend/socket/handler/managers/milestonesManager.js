...
module.exports = function (io) {
    ...
    io.on('connection', client => {
        client.on('USER_CREATE_MILESTONE', async (projectID, milestoneID, milestoneName, date) => {
            const result = await projectMilestonesController.insertNewMilestone(projectID, milestoneID, milestoneName, date)
