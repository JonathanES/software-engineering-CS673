...
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(2,2,4,2,1,'Creating messaging groups','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(2,2,4,3,3,'Save chat into database','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(2,2,4,2,3,'Direct messaging','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(3,3,4,2,3,'[BUG] Do not display a chat to everybody','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(3,3,4,1,2,'update direct message','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(3,3,6,1,2,'create issue backend support','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(3,3,7,2,2,'Finish Milestones Controller','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(4,4,2,3,2,'able to add task to database table','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(4,4,2,3,2,'add priority status table','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(4,4,4,3,2,'get direct messages of a chat','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(4,4,4,3,2,'insert direct message in database','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(4,4,2,3,2,'create a model for AccountType','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(4,4,2,3,2,'create a model for ProjectUsers','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(4,4,7,3,2,'Create comments','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(4,4,2,3,2,'backend support for Projects Table','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(5,5,8,1,2,'Add Menubar with tabs','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(5,5,5,1,2,'Create Login Interface','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(5,5,5,2,2,'Login and Register page html+css','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(5,5,8,3,2,'Mainpage design html+css','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(6,6,3,3,3,'Create the messaging interface','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(7,7,4,3,3,'Deploy the database on AWS','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
INSERT INTO Tasks(ParentID, CategoryID, UserID, StatusID, PriorityID, TaskName, TaskInfo, CreatedDate, DueDate, ExpectedDuration, ActualTimeSpent) Values(7,7,4,1,3,'Deployed the backend and frontend on AWS','N/A','2019-06-06','2019-07-27 00:00:00',10,10);
Select * from Tasks;
...
--Adding Ron to Project Groups
INSERT INTO GroupUsers(UserID,GroupID) Value(378,1);
INSERT INTO GroupUsers(UserID,GroupID) Value(378,2);
INSERT INTO GroupUsers(UserID,GroupID) Value(378,3);
INSERT INTO GroupUsers(UserID,GroupID) Value(378,4);
INSERT INTO GroupUsers(UserID,GroupID) Value(378,5);
INSERT INTO GroupUsers(UserID,GroupID) Value(378,6);

INSERT INTO GroupUsers(UserID,GroupID) Value(380,1);
INSERT INTO GroupUsers(UserID,GroupID) Value(380,2);
INSERT INTO GroupUsers(UserID,GroupID) Value(380,3);
INSERT INTO GroupUsers(UserID,GroupID) Value(380,4);
INSERT INTO GroupUsers(UserID,GroupID) Value(380,5);
INSERT INTO GroupUsers(UserID,GroupID) Value(380,6);

INSERT INTO ProjectUsers(UserID, ProjectID, AccountTypeID) Values(380,2,1);
INSERT INTO ProjectUsers(UserID, ProjectID, AccountTypeID) Values(380,3,1);
INSERT INTO ProjectUsers(UserID, ProjectID, AccountTypeID) Values(380,4,1);

INSERT INTO ProjectUsers(UserID, ProjectID, AccountTypeID) Values(378,2,1);
INSERT INTO ProjectUsers(UserID, ProjectID, AccountTypeID) Values(378,3,1);
INSERT INTO ProjectUsers(UserID, ProjectID, AccountTypeID) Values(378,4,1);
